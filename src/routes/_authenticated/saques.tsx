...
<PageHeader 
        title="Saques" 
        description="Acompanhe suas solicitações de saque via PIX. Limite de 1 saque por dia. Até R$ 1.000 o envio é automático; acima disso, aguarda aprovação. Rendimentos: Segundas (10h-17h). Bônus: Diariamente (09h-17h). Taxa de 2%."
        action={
